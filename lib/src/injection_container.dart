...
// Datasources
  ...
  sl.registerLazySingleton<OrderRemoteDataSource>(() => FakeOrderRemoteDataSource());
  sl.registerLazySingleton<OrderRemoteStorage>(
      () => FakeOrderRemoteStorage());
...
// Datasources
  ...
  sl.registerLazySingleton<ChatRemoteDataSource>(() => FakeChatRemoteDataSource());
  sl.registerLazySingleton<ChatRemoteStorage>(() => FakeChatRemoteStorage());
