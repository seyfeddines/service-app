...
class ImageMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Detect if image is a local file path (not a URL)
    bool isLocalFile = !image.startsWith('http://') && !image.startsWith('https://');
    return SizedBox(
        ...
        children: [
          Stack(
            children: [
              ImageContainer(
                image: image,
                imageSource: isLocalFile ? From.file : From.network,
